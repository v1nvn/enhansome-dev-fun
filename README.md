# Awesome Dev Fun [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 462,163 | 🐛 73 | 📅 2026-05-03 with stars
...
* [OOP](https://github.com/wojtekmach/oop) ⭐ 328 | 🐛 0 | 🌐 Elixir | 📅 2021-06-22 - OOP in Elixir!

## Golang

* [gomatrix](https://github.com/GeertJohan/gomatrix) ⭐ 315 | 🐛 6 | 🌐 Go | 📅 2023-11-28 - Connect to The Matrix and display it's data streams in your terminal.
...
* [FizzBuzzEnterpriseEdition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,636 | 🐛 545 | 🌐 Java | 📅 2024-07-15 - A no-nonsense implementation of FizzBuzz made by serious businessmen for serious business purposes.
...
* [jsFuck](https://github.com/aemkei/jsfuck) ⭐ 8,586 | 🐛 38 | 🌐 JavaScript | 📅 2025-03-10
...
* [Echochamber.js](https://github.com/tessalt/echo-chamber-js) ⭐ 4,117 | 🐛 12 | 🌐 JavaScript | 📅 2019-05-10 - Commenting without the comments - providing a single-sided user comments just stored in local storage.
* [fartscroll.js](https://github.com/theonion/fartscroll.js) ⚠️ Archived - Everyone farts. And now your web pages can too.
* [vapor.js](https://github.com/madrobby/vapor.js) ⭐ 1,408 | 🐛 62 | 🌐 JavaScript | 📅 2022-07-19 - The World's Smallest & Fastest JavaScript Library.
...
* [Sarcasm](https://github.com/komlev/sarcasm) ⭐ 120 | 🐛 4 | 🌐 JavaScript | 📅 2019-01-25 - Sarcasm is easy-as-pie, batteries-included, non-opinionated, simple-to-get-started, lightweight, reliable, convenient, dead simple, user friendly, super-sonic, hipercharged, kick-ass JavaScript library on steroids.
...
* [gremllm](https://github.com/awwaiid/gremllm) ⭐ 647 | 🐛 0 | 🌐 Python | 📅 2025-07-19 - Always a good idea to add gremlins to your code in a modern fashion.
...
* [Vigil](https://github.com/munificent/vigil) ⭐ 3,030 | 🐛 26 | 🌐 Python | 📅 2022-09-26 - Vigil, the eternal morally vigilant programming language.
...
* [Corporate Bullshit/Buzzword Generator API](https://github.com/sameerkumar18/corporate-bs-generator-api) ⭐ 339 | 🐛 2 | 🌐 JavaScript | 📅 2023-04-13 - Corporate bullshit generator that randomly picks out phrases, which can help your application get ahead in an industry where spin, buzzwords and vagueness reign supreme.
...
* [Cloud to butt](https://github.com/panicsteve/cloud-to-butt) ⭐ 1,500 | 🐛 19 | 🌐 JavaScript | 📅 2024-02-19 - Chrome extension that replaces occurrences of 'the cloud' with 'my butt'.
...
* [Chucknorris](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins#chucknorris) ⭐ 186,691 | 🐛 551 | 🌐 Shell | 📅 2026-05-03 - A Chuck Norris fortune plugin for ZSH.
* [genact](https://github.com/svenstaro/genact) ⭐ 12,024 | 🐛 12 | 🌐 Rust | 📅 2026-05-01 - 🌀 A nonsense activity generator for your shell.
* [git-blame-someone-else](https://github.com/jayphelps/git-blame-someone-else) ⭐ 11,621 | 🐛 21 | 🌐 Shell | 📅 2023-12-04 - Blame someone else for your bad code.
* [No More Secrets](https://github.com/bartobri/no-more-secrets) ⭐ 7,788 | 🐛 1 | 🌐 C | 📅 2025-12-13 - A command line tool that recreates the famous data decryption effect seen in the 1992 movie Sneakers.
* [lolcat](https://github.com/busyloop/lolcat) ⭐ 6,526 | 🐛 32 | 🌐 Ruby | 📅 2024-03-05 - Rainbows and unicorns!
* [cmatrix](https://github.com/abishekvashok/cmatrix) ⭐ 5,050 | 🐛 80 | 🌐 C | 📅 2024-08-21 - Make it digital rain in your terminal like The Matrix.
* [lolcommits](https://github.com/mroth/lolcommits) ⭐ 4,809 | 🐛 40 | 🌐 Ruby | 📅 2026-04-19 - Git-based selfies for software developers.
* [sl](https://github.com/mtoyoda/sl) ⭐ 3,266 | 🐛 38 | 🌐 C | 📅 2024-06-11 - SL (Steam Locomotive) runs across your terminal when you type "sl" as you meant to type "ls".
* [pipes.sh](https://github.com/pipeseroni/pipes.sh) ⭐ 2,957 | 🐛 13 | 🌐 Shell | 📅 2024-08-12 - Animated pipes terminal screensaver.
...
* [No Code](https://github.com/kelseyhightower/nocode) ⭐ 65,249 | 🐛 4,710 | 🌐 Dockerfile | 📅 2024-08-07 - The best way to write secure and reliable applications. Write nothing; deploy nowhere.
* [Volkswagen](https://github.com/auchenberg/volkswagen) ⭐ 15,421 | 🐛 23 | 🌐 JavaScript | 📅 2026-02-27 - 🙈 Volkswagen detects when your tests are being run in a CI server, and makes them pass.
...
* [πfs](https://github.com/philipl/pifs) ⭐ 6,894 | 🐛 56 | 🌐 C | 📅 2026-04-01 - π contains every possible digit sequence in existence.  I'm sure your data is in there *somewhere*.
* [parrot.live](https://github.com/hugomd/parrot.live) ⭐ 4,429 | 🐛 3 | 🌐 JavaScript | 📅 2026-01-17 - 🐦 Bringing animated parrots to terminals everywhere.
